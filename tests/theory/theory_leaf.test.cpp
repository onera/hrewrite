...
using t_term        = tt_term<t_theory_leaf>;
using t_factory     = tt_factory<t_theory_leaf>;

using t_term_inner   = typename t_theory_leaf::template tt_term<t_term>;
...
TEST_CASE("theory leaf") {
  std::cout << "==================================================================\n";
  std::cout << "= theory leaf\n";

  t_factory th;
  t_term t = th.create_term(0, 0);
...
TEST_CASE("theory leaf unicity") {
  std::cout << "==================================================================\n";
  std::cout << "= theory leaf unicity\n";

  t_factory th;
  t_term t1 = th.create_term(0, 0);
  t_term t2 = th.create_term(0, 0);
  t_term t3 = th.create_term(0, 1);
